...
def purge_async(tags):
    """Purge Vercel cache tags in background thread (non-blocking)."""
    threading.Thread(
...
def create_product(product_data: ProductCreate):
    ...
    try:
        ...
        # ✅ CHANGE 1: Use TAGS not paths
        purge_async(["products", "categories"])
...
# ================================
# 2. GET /products — Add tag header + shorter TTL
# ================================
@router.get("/products")
def get_all_products(
    ...
    try:
        ...
        return JSONResponse(
            content={"success": True, "products": products, "count": len(products)},
            headers={
...
# ================================
# 3. GET /products/top — Add tag header + shorter TTL
# ================================
...
# ================================
# 5. PUT /products/{product_id} — Purge by tags
# ================================
...
# ================================
# 6. DELETE /products/{product_id} — Purge by tags
# ================================
